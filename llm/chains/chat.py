...
def run_chat_chain(prompt: str, session_id: str, primary_language: str):
    llm = get_llm()
    ...
    chain_prompt = chat_chain_prompt(primary_language)
...
def chat_chain_prompt(language: str) -> ChatPromptTemplate:
